...
function renderTask(newTask) {
  ...
  const progressbar = `
        ...
        `;
  const playButton =
    '<a class="p-2" href="https://www.google.com/"><span class="material-icons play-btn">play_circle</span></a>';
  ...
  list.insertAdjacentHTML(
    position,
    `<li id=${uid}, class="taskNode d-flex flex-row bd-highlight" draggable = true>${dragButton}${checkmark}${todoTask}${progressbar}${playButton}${editButton}`
  );
}
...
/**
 * Where Am I in the website.
 * @param {event.clientY} currentYPos: description....
 */
